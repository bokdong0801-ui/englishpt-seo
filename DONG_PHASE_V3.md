...
- 무료 PT 진단 CTA
- 페이지 전체는 중립 `theme-local`을 유지하고, 초등/중등/고등/대학생/취준생/직장인/성인·주부 카드에서 각 대상 theme accent를 미리 보여준다.
- 대상별 서비스 페이지로 이동하면 해당 audience theme와 content blueprint로 완전히 전환한다.
